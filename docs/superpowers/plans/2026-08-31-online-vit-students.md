...
- [x] **Step 1: Write failing encoder tests**
...
- [x] **Step 3: Implement patch embedding, twelve Transformer blocks, token extraction, and four-scale interpolation**
...
- [x] **Step 4: Run encoder tests and existing model tests**
...
- [x] **Step 1: Write failing config and CLI construction tests**
...
- [x] **Step 3: Implement config parsing, CLI dispatch, template, and documentation**
...
- [x] **Step 1: Run static checks without formatting third-party source**
...
- [x] **Step 2: Run full tests and package build**
...
- [x] **Step 3: Commit verification record**
